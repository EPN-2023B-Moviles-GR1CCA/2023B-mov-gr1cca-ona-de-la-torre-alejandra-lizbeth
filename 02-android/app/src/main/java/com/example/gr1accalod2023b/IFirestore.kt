...
class IFirestore : AppCompatActivity() {
    ...
    fun consultarCiudades(
        ...
        if(query == null){
            ...
            // consulta de la consulta anterior empezando en el nuevo
            tarea = query!!.get()
        }
                ...
                arreglo
                    .add(
                        ICities(
                            ...
                            it.data?.get("regions") as String? as ArrayList<String>?
                        )
                    )
                adaptador.notifyDataSetChanged()
            }
