...
class Cocinero_edicion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(codigoUnicoCocineroEdicion != null){
            ...
            BDD.bddAplicacion!!.consultarCocineroPorCodigoUnico(codigoUnicoCocineroEdicion)
                .addOnSuccessListener { documentSnapshot ->
                    if (documentSnapshot.exists()) {
                        // El cocinero existe
                        val cocineroEdicion = documentSnapshot.toObject(Cocinero::class.java)
                        ...
                        codigoUnico.setText(documentSnapshot.id) //id del documento representa en este caso el codigoUnico
...
//                    mostrarSnackbar(codigoUnico.text.toString())
                    if(validarCampos(codigoUnico, nombre, apellido, edad, fechaContratacion, salario, isMainChef)){
                        ...
                        BDD.bddAplicacion!!.actualizarCocineroPorCodigoUnico(datosActualizados)
